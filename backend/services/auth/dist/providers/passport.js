...
if (locals_1.default.config().microsoftClientId &&
    locals_1.default.config().microsoftClientSecret) {
...
if (locals_1.default.config().githubClientId && locals_1.default.config().githubClientSecret) {
    console.log("GITHUB URL", locals_1.default.config().githubClientId);
    const callbackURL = "http://127.0.0.1:9090/backend/auth/authentication/signin/github/callback";
